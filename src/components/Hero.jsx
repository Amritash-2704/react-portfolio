...
import devboy from "../assets/devboy_converted.png"
            ...
            <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-center">
                ...
                <div>
                    ...
                    <div className="flex space-x-4">
                        <button className="px-6 py-3 bg-cyan-500 hover:bg-cyan-600 rounded-lg font-semibold shadow-lg shadow-cyan-500/30 transition">
                            Download CV
                        </button>

                        <button className="px-6 py-3 border border-cyan-400 text-cyan-400 hover:bg-cyan-400 hover:text-black rounded-lg transition">
                            Contact Me
                        </button>
                    </div>
                </div>
